 ...
 * @author User
 */
public class AllOrdersWindow extends javax.swing.JFrame {

    /**
     * Creates new form AllOrdersWindow
     */
    public AllOrdersWindow() {
        ...
        DefaultTableModel all = (DefaultTableModel) customerDetailsTable.getModel();
        all.setRowCount(0);
        ...
        for (int i = 0; i < CustomerController.getSizeOfList(); i++) {
            ...
            Object[] allRowData = {(tempArray[i].getOrderId()), (tempArray[i].getCustomerId()), (tempArray[i].getSize()),
                (tempArray[i].getqty()), (tempArray[i].getAmount()), (tempArray[i].getStatus())};
            all.addRow(allRowData);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AllOrdersWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
