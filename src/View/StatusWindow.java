...
public class StatusWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        statusButton.setBackground(new java.awt.Color(115, 120, 218));
    ...
    private void statusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_statusButtonActionPerformed
        ...
        if (c1.getStatus().equals("PROCESSING")) {
            ...
            int indexOption = JOptionPane.showOptionDialog(
                    StatusWindow.this, //parent
            ...
            if (indexOption == 0) {
                boolean isAdded = CustomerController.addIndexOf(index, "DELIVERING");
                if (isAdded) {
                    customerIdText.setText("");
                    ...
                    statusText.setText("");
                    statusButton.setEnabled(false);
                    JOptionPane.showMessageDialog(StatusWindow.this, "Order Status is set as DELIVERING");
                }
            } else if (indexOption == 1) {
                boolean isAdded = CustomerController.addIndexOf(index, "DELIVERED");
                ...
                if (isAdded) {
                    ...
                    statusText.setText("");
                    statusButton.setEnabled(false);
                    JOptionPane.showMessageDialog(StatusWindow.this, "Order Status is set as DELIVERED");
                }
            }
            ...
            JOptionPane.showMessageDialog(StatusWindow.this, "Can't change the status\nOrder is already DELIVERED", "Error", JOptionPane.ERROR_MESSAGE);
            customerIdText.setText("");
